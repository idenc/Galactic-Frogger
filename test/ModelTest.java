...
public class ModelTest {
    ...
    public void test_updateFrog_FrogReachedEnd() {
        ...
        f.setY(0);
        modT.updateFrog();
        assertFalse("Running Should be set to false", modT.getRunning());
        assertTrue("Won should be set to True", modT.getWon());
    }
    ...
    public void test_updateFrog_FrogNotReachedEnd() {
        ...
        f.setY(8);
        modT.updateFrog();
        assertTrue("Running Should be true", modT.getRunning());
        assertFalse("Won should be false", modT.getWon());
    }
